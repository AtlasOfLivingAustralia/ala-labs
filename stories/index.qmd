...
Through art and story, Aboriginal and Torres Straight Islander People capture deep connections and rich knowledge in nature that may not be documented or recorded. This traditional knowledge carries glimpses of the past, a view of our present, and even predictions for the future.

How does traditional knowledge overlap with Western-collected data? Do the records stored in infrastructures like the Atlas of Living Australia (ALA) reflect or contrast traditional knowledge of a given ecosystem? Continue scrolling to explore the story of this artwork and the data interwoven through it.
...
:::
:::{.group-2 style="margin-left: auto; margin-right:auto;"}
Some species in this painting like the Northern brown bandicoot (*Isoodon macrourus*) are also nocturnal, primarily active at [**night**]{style="color:#5F84AF;"} instead of [**day**]{style="color:#FFC557;"}. This makes it less likely that people see and record these species, reducing record numbers. In this case, there are only 33 records of Northern brown bandicoots in Mareeba.
:::
:::
::::
...
Hear more about the inspirations and cultural this painting and the Muluridji people's cultural connection to these animals from artist Ann-Marie Keating in the following video:  
*Note: I don't think the video will render correctly until the article is published*
...
One thing we have learned is that there are comparitively many bird observations on the Atlas of Living Australia. Birds hold great significance to Keating and her family.
...
Of course, there are many other animals that are not birds depicted in this painting that hold great cultural significance to the Muluridji people. 
