...
Here, we'll download all *Aves* (bird) data provided by BirdLife Australia in each suburb. To only download records within the ACT, we can also use `galah_filter()` to narrow our download to only records within the longitude and latitude of the ACT.
