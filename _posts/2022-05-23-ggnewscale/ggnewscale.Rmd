...
Choropleth maps visually summarise how variables (for example, density of lamp posts or books read per capita) varies across geographic areas. These maps require two things:  
...
We now have the two things we need to make a choropleth: 

* IBRA/IMCRA boundaries, and 
