...
`feather` package by Shandiya Balasubramaniam, which gives colors based on 
Australian bird plumage
...
First, get observations of the Eucalypt of the Year 2021 from ALA using the [galah](https://atlasoflivingaustralia.github.io/galah/index.html) package. Specifically, we use `ala_counts()` to determine how many records of *Eucalyptus salubris* are held by the ALA:
