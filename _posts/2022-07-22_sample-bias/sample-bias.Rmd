...
We use the `calculate_bias()` function to run our model. We have specified that our model make estimates at a fine spatial scale resolution of `res = 0.05` and we have added a buffer, which helps our model account for any neighbouring features just outside of our specified area that might affect our data. We also make sure to restrict our model to be within our map of the Northern Territory, ensuring it is in the correct format by using `sf:::as_Spatial(nt_wgs84)`.
...
<details><summary>Expand for code to create map</summary>
...
```{r, out.width=c('30%', '30%'), fig.show='hold', out.extra='style="clip-path: circle();"', fig.align="center", echo=FALSE}
#| fig.cap = "Left: [*Dasyurus hallucatus* (David White CC BY-NC 4.0)](https://images.ala.org.au/image/a69e5f4d-6bd2-474c-8f35-1159172c73de), Right: [*Dasycercus blythi* (Robert Browne-Cooper CC-BY-NC 3.0 (Au))](https://images.ala.org.au/image/45ce8ffe-e4cf-4458-bfa0-3089c88e3dc9)"

# Images
knitr::include_graphics("https://ala-images.s3.ap-southeast-2.amazonaws.com/store/e/d/3/7/a69e5f4d-6bd2-474c-8f35-1159172c73de/original")
knitr::include_graphics("https://ala-images.s3.ap-southeast-2.amazonaws.com/store/9/c/d/3/45ce8ffe-e4cf-4458-bfa0-3089c88e3dc9/original")
```

```{r, echo = FALSE, layout="l-body-outset"}
model_bias_quoll <- readRDS(file = here::here("_posts", "data", "nt_out_quoll.rds"))
...
```{r, out.width=c('30%', '30%'), fig.show='hold', out.extra='style="clip-path: circle();"', fig.align="center", echo=FALSE}
#| fig.cap = "Left: [*Ceyx pusillus* (Greg Holland CC BY-NC 4.0)](https://images.ala.org.au/image/f6827b1e-b4fb-4247-a89a-1865c775b8e7), Right: [*Ceyx pusillus* (Graham Winterflood CC-BY-SA 4.0 (Au))](https://images.ala.org.au/image/8e2ba023-a6a0-4efc-8704-d9aee2291684)"

# Images
knitr::include_graphics("https://ala-images.s3.ap-southeast-2.amazonaws.com/store/7/e/8/b/f6827b1e-b4fb-4247-a89a-1865c775b8e7/original")
knitr::include_graphics("https://ala-images.s3.ap-southeast-2.amazonaws.com/store/4/8/6/1/8e2ba023-a6a0-4efc-8704-d9aee2291684/original")
```

```{r, echo = FALSE, layout="l-body-outset"}
model_bias_kingfisher <- readRDS(file = here::here("_posts", "data", "nt_out_kingfisher.rds"))
...
```{r, out.width=c('30%', '30%'), fig.show='hold', out.extra='style="clip-path: circle();"', fig.align="center", echo=FALSE}
#| fig.cap = "Left: [*Hierodula majuscula* (Michael Mcmaster CC BY-NC 4.0)](https://images.ala.org.au/image/c8a03411-a0b3-4728-8c26-b188f42c0cba), Right: [*Tenodera australasiae* (Reiner Richter CC BY-NC-SA 4.0))](https://images.ala.org.au/image/1abd3107-42ae-476a-b2c9-ef5ff949266f)"

# Images
knitr::include_graphics("https://ala-images.s3.ap-southeast-2.amazonaws.com/store/a/b/c/0/c8a03411-a0b3-4728-8c26-b188f42c0cba/original")
knitr::include_graphics("https://ala-images.s3.ap-southeast-2.amazonaws.com/store/f/6/6/2/1abd3107-42ae-476a-b2c9-ef5ff949266f/original")
```

```{r, echo = FALSE, layout="l-body-outset"}
model_bias_mantid <- readRDS(file = here::here("_posts", "data", "nt_out_mantid.rds"))
...
```{r, out.width=c('30%', '30%'), fig.show='hold', out.extra='style="clip-path: circle();"', fig.align="center", echo=FALSE}
#| fig.cap = "Left: [*Crotalaria cunninghamii* (Gerald Krygsman CC BY-NC 4.0)](https://images.ala.org.au/image/d17e3e6f-45f5-4841-99fd-4df85a671e14), Right: [*Crotalaria cunninghamii* (Steve Dew CC BY-NC 4.0))](https://images.ala.org.au/image/d2ff7a79-3a40-4d26-830e-090222b0291b)"

# Images of Birdflowers
knitr::include_graphics("https://ala-images.s3.ap-southeast-2.amazonaws.com/store/4/1/e/1/d17e3e6f-45f5-4841-99fd-4df85a671e14/original")
knitr::include_graphics("https://ala-images.s3.ap-southeast-2.amazonaws.com/store/b/1/9/2/d2ff7a79-3a40-4d26-830e-090222b0291b/original")
```

```{r, echo = FALSE, layout="l-body-outset"}
model_bias_birdflower <- readRDS(file = here::here("_posts", "data", "nt_out_birdflower.rds"))
