...
**Plot B** compares the effect of each biasing factor on the sampling rate. Lines that curve more steeply indicate a drop-off in how likely an observation occurs as we get further from each feature. For *Delma*, getting further than 250 km from an airport effectively cuts the expected number of observations by around half.
