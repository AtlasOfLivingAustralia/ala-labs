...
description: |
  Convex and alpha hulls are wonderful alternatives to visualising species distributions.
...
[Margot Schieder](https://labs.ala.org.au/people/Schieder_Margot/index.html)
...
```{r, out.width=c('120px'), fig.align='center', fig.show='hold', out.extra='style="clip-path: circle(70% at 50% 10%);"', echo=FALSE}
...
# Images of Powdered Flatwing
# knitr::include_graphics("") # Not sure how to call like sampbias Delma post
...
#### Alpha hull using all types data {.panel-name}
...
#### Alpha hull using specimen data {.panel-name}
