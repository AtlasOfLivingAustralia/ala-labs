...
Since it's all looking correct, we can add some final flourishes to make our map more aesthetically pleasing, as well as more accessible with a colourblind friendly palette by [Paul Tol](https://personal.sron.nl/~pault/).
```{r}
#| echo: true
#| code-fold: true
#| fig-height: 7
