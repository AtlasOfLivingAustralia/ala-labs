...
How this affects our ability to know the true location of a species in an area is illustrated in the diagram below. The *true* location of the point is nearby[^nearby], but the process of generalisation has removed decimal points which seems to "snap" the point to the corner of a grid cell, the size of which depends on the the distance of generalisation. Whether the point snaps up or down will depend on which direction the point was rounded[^snapping]. What this means is that it's possible that a given data point falls within any of the following three scenarios:
...
orig_points = {0: [149.7,-32], 1: [149.9,-32.45], 2: [149.9,-32.9]}
obf_points = {0: [149.6,-32.15], 1: [150.05,-32.6], 2: [150.05,-33.05]}
titles = {0: '1', 1: '2', 2: '3'}
...
for i in range(len(ax)):
    ...
    a = ax[i].set_xticks(list(np.arange(148.7,150.8,0.45)))
    a = ax[i].set_yticks(list(np.arange(-33.5,-31.8,0.45)))
