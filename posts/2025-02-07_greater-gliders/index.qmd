...
Just like we did with the tree cover data, we need to clean up these rasters: 
...
This raster is NOT in EPSG:4326 projection, so we are going to be doing the following steps:
