...
| **BIO12 (Annual Precipitation)** | **0.0002668** - More rainfall slightly increases the predicted chance of glider presence. | **297.31** - Another positive predictor. When considered alongside tree cover and elevation, this makes sense as higher tree cover typically requires more precipitation. |
...
| **Fire Period (Before or After)** | **0.02963** - Fire period slightly influences glider presence in a positive way. This is interesting, as our results indicate a slight preference for post fire sightings. This could be due to the creation of hollow bearing trees - or some other factor, or potentially skewed by our data (maybe more people were out looking for Gliders after the fires than before?) | **78.99** - It is the weakest predictor in our model, but it still plays a minor role in determining glider presence. |
...
4. Strong fires have a negative impact - The more extreme the fire events in the 2019 bushfire season, the less likely we were to see gliders present. Fires that are too intense can scorch and destroy the critical habitat needed by Greater Gliders, and destroy the hollow bearing trees needed for them. It is worth noting that fire can also create hollows in trees! However our model suggests that these intense fires did disrupt their habitat in a negative way.

5. Pre vs Post fire presence - There was a slight influence of fire presence in an area. The exact nature of this requires a bit more exploring.

This SDM gives us an interesting insight into the impact of the 2019 bushfires on glider distribution. It's clear that when accounting for these other climactic variables, fire negatively impacts Glider range and habitat. This sort of modelling gives us a great starting point into deeper more nuanced analysis, and can help inform conservation planning and the impact that various environmental factors like fire have on a species range and habitat.