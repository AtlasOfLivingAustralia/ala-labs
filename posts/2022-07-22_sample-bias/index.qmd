...
<img class = "clipped" src="https://images-assets.ala.org.au/store/7/8/8/e/146a0211-325f-4b4b-938f-d9582ccbe887/thumbnail_large"></img>

<img class = "clipped"src="https://images-assets.ala.org.au/store/7/4/b/a/c295146a-acd0-4f57-a819-d4c1f7f6ab47/thumbnail_large"></img>

<img class = "clipped" src="https://images-assets.ala.org.au/store/e/b/1/9/3a00210e-c043-4d4d-b884-04ce3e3f91be/thumbnail_large"></img>
...
```{r}
#| echo: false
model_bias_delma <- readr::read_rds(file = here::here("posts", "data", "nt_out-updated.rds"))
```
...
# Load in data for landscape features as sf objects
airports <- ne_download(scale = "large", type = "airports", category = "cultural", returnclass = "sf")
cities <- ne_download(scale = "large", type = "urban_areas", category = "cultural", returnclass = "sf")
waterbodies <- ne_download(scale = "large", type = "rivers_lake_centerlines", category = "physical", returnclass = "sf")
roads <- ne_download(scale = "large", type = "roads", category = "cultural", returnclass = "sf")

# Combine into a named list
features <- list(airports, cities, waterbodies, roads)

# Set coordinate system, filter to within NT
...
<img class = "clipped" src="https://images-assets.ala.org.au/store/e/d/3/7/a69e5f4d-6bd2-474c-8f35-1159172c73de/thumbnail_large"></img>

<img class = "clipped"src="https://images-assets.ala.org.au/store/9/c/d/3/45ce8ffe-e4cf-4458-bfa0-3089c88e3dc9/thumbnail_large"></img>
...
<img class = "clipped" src="https://images-assets.ala.org.au/store/7/e/8/b/f6827b1e-b4fb-4247-a89a-1865c775b8e7/thumbnail_large"></img>

<img class = "clipped"src="https://images-assets.ala.org.au/store/4/8/6/1/8e2ba023-a6a0-4efc-8704-d9aee2291684/thumbnail_large"></img>
...
<img class = "clipped" src="https://images-assets.ala.org.au/store/a/b/c/0/c8a03411-a0b3-4728-8c26-b188f42c0cba/thumbnail_large"></img>

<img class = "clipped"src="https://images-assets.ala.org.au/store/f/6/6/2/1abd3107-42ae-476a-b2c9-ef5ff949266f/thumbnail_large"></img>
...
<img class = "clipped" src="https://images-assets.ala.org.au/store/4/1/e/1/d17e3e6f-45f5-4841-99fd-4df85a671e14/thumbnail_large"></img>

<img class = "clipped"src="https://images-assets.ala.org.au/store/b/1/9/2/d2ff7a79-3a40-4d26-830e-090222b0291b/thumbnail_large"></img>
