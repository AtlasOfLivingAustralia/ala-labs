...
Finally, we can avoid adding more than one legend by using colour in our title to specify that protected areas are coloured green, and dingo observations are coloured dark blue ([with a clever method by Cara Thompson](https://twitter.com/cararthompson/status/1539662532608020480)). We'll need to use `ggnewscale::new_scale_color()` to allow us add our custom text palette in a plot where we already have another palette for our observation points (see our [previous post on using {ggnewscale}](https://labs.ala.org.au/posts/2022-05-23-ggnewscale/post.html)).
...
:::{.callout-tip}
To find the number of points that intersect with CAPAD polygons, we used a method described in a previous article. You can [check it out here](https://labs.ala.org.au/posts/2023-01-12_counting-points-in-shapefiles/post.html#count-points-in-each-polygon)!
:::
...
We'll also include a map of where the Dingo Fence is within South Australia to see compare observations on either side (including near it). We obtained a shapefile of the Dingo Fence by emailing the [Department of Primary Industries and Regions](https://pir.sa.gov.au/biosecurity/introduced-pest-feral-animals/find_a_pest_animal/wild_dogs_and_dingoes/dog_fence).
...
One explanation could be due to differences in legislation between states. The Northern Territory is one of only two states in Australia that [recognises dingoes as a protected species](https://nt.gov.au/environment/animals/feral-animals/wild-dog#:~:text=Dingoes%20are%20protected%20in%20the,take%20or%20interfere%20with%20wildlife.) (the other is [Victoria](https://www.wildlife.vic.gov.au/our-wildlife/dingoes)). In these states, governments may be more interested in monitoring dingoes to maintain their distributions, and therefore have more surveys or programs in place to collect data.

South Australia's high number of dingo observations, however, is a little more surprising. South Australia is one of several states that have a mixed wild dog control policy, where wild dogs and dingoes are controlled in some areas and protected in others. [In South Australia](https://pir.sa.gov.au/biosecurity/introduced-pest-feral-animals/find_a_pest_animal/wild_dogs_and_dingoes), inside the Dog Fence landholders have a legal responsibility to control wild dogs - including dingoes - on their properties, whereas outside of the Dog Fence dingoes are listed as unprotected native wildlife. There are similar mixed policy strategies in [New South Wales](https://www.environment.nsw.gov.au/topics/parks-reserves-and-protected-areas/park-policies/wild-dogs) and [Queensland](https://www.business.qld.gov.au/industries/farms-fishing-forestry/agriculture/biosecurity/animals/invasive/wild-dogs/law), while in Western Australia dingoes are required to be controlled because they are [classified as a pest species](https://www.agric.wa.gov.au/state-barrier-fence/wild-dogs). In these states, control methods may occur at locations without data ever being recorded.

Despite evidence that [dingoes can be allies for livestock producers](https://theconversation.com/killing-dingoes-is-the-only-way-to-protect-livestock-right-nope-200905). Habitat loss combined with historical and current control programs have reduced total dingo numbers. Dingoes are currently listed as [vulnerable to extinction under the IUNC's Red List of Threatened Species](https://www.iucnredlist.org/species/41585/10484199). 
