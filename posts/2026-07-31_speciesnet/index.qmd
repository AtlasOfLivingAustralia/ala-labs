...
First we'll define a small helper function that prints predictions in a readable format.
...
All images in this run are identified as *Sus scrofa* (feral pig) or *Felis catus* (domestic cat) in the ALA, but SpeciesNet returned three different predictions: 
