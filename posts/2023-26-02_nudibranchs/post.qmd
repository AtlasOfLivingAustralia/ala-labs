...
**Species distribution models** (SDMs) are used to predict the habitat range of different organisms. They offer some of the most informative ways to show how shifting environmental conditions affect where species occur in an area, knowledge that is key to managing ecosystems, conserving species and predicting effects of global warming. 

Species rarely stay in the same spot for long periods of time. Just like us, they react to changes in their environment, interactions with other species, and interactions with other individuals. As a result, it can be more useful to see how a distribution of a species changes *over time*. Particularly in marine environments where [seemingly small changes in temperature, light or chemical composition can result in large changes in species distributions]().
