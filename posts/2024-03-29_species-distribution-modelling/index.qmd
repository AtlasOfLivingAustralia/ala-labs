...
A **raster** is a spatial grid of cells, where each cell is assigned a value. Each cell represents a pixel, and each pixel's colour and gradient is defined by its cell value. The resolution of the raster depends on the size of each pixel (just like a TV or computer screen).

Here is a simple and slightly less simple example of a raster cell grid.
