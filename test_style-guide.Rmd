...
## Create an independent ALA R markdown file
...
You can also use `here::i_am()` to set the project root path based on your current file location:
...
People who read your code should be able to understand what your code does and why you made the choices you did. It is helpful to include brief summaries of what your code is meant to do, and the logic of any decision you might make after seeing a result or output (for example, if your code used a statistical model you can include your basic interpretation and why it might lead to any subsequent code). If there is something in your code output you wish to highlight, it is best to write what you think your reader should be seeing than to expect your reader to know what they should see in your output <br>

##  Code chunks

We use sentences and paragraphs when writing to build a flowing, logical story or argument. In the same way, we can use code chunks to structure our script to build a flowing, logical analysis or plot. <br>
