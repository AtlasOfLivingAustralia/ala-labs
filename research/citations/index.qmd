...
df <- here::here("research", "data", "2026-24-02_ala-publications.csv") |>
  readr::read_csv(show_col_types = FALSE) |>
  janitor::clean_names() |>
  filter(item_type == "journalArticle") |>
  mutate(
    date_formatted = parse_date_time(date, orders = c("ymd", "ym", "y")) |> as_date()
  ) |> 
  arrange(desc(date_formatted)) |>
  select(author, publication_year, title, publication_title, doi, date_added, date_formatted)
