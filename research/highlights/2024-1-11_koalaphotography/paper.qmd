...
::: {.paper-main-column}
Images can provide myriad information useful to conservation efforts. A picture can capture changes in species traits and habitats, and sometimes even identify unique individuals of a species, making it possible for researchers to monitor individuals in a non-invasive manner. 

Koalas are one species that researchers are able to distinguish between individuals using fur patterns, skin markings, and even face shape. Danaher et al. (2023) explained how just one citizen scientist can make a huge impact on biodiversity data using pictures, evidenced by the work of Charley Geddes. 
