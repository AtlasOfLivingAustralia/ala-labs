...
They found that pollen levels were generally highest from April to May in both areas, but that levels fluctuate across the entire calendar year. Importantly, different grasses have different peak times of airborne pollen, and the ecological composition of grasses in each area might provide nuanced insight into pollen-induced allergies. While genera from the [Poaceae grass family](#0) contribute to pollen in springtime, grass species from other families flowered from late spring to autumn.
:::
:::
