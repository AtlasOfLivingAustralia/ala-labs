...
![](images/homepage/home_ala-stories_smaller.png){.home-img}
</a>
...
<center> <h1 class="heading-home">Stories</h1>

<span style = "font-style: italic">Data-focused stories that deep-dive into ALA data</span>
...
tags$div(class = "category-row",
  ...
  tags$div( 
    class = "category-column",
    style = "width: 100%",
    tags$a(href = "stories/story-of-mareeba/index.html",
      tags$img(
        href = "stories/story-of-mareeba/index.html",
        src = "images/vectors/palette-fill.svg",
        class = "category-image honey"
  )),
  tags$h4(style = "text-align:center;",
      tags$a(href = "research/highlights/index.html", "Story of\nMareeba"))
  ))
```
