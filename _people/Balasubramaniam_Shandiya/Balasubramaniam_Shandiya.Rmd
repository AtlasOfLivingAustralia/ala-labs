...
<a href='https://labs.ala.org.au/posts/2022-05-23-multiple-scales-in-choropleth-maps-with-ggnewscale/'>Multiple scales in choropleth maps with ggnewscale}</a><br><em>Wherein we download records of plants from the ALA and scale the dizzy heights of adding multiple colour scales to differentiate marine and terrestrial records</em><br><br>
