...
```
Dax is an evolutionary biologist, with a PhD in biological sciences and social psychology. As a data analyst at the ALA, he facilitates scientific rigour and transparency and works to make it easier for researchers to do the same. Dax is an advocate for diversity in STEMM.
```{r, echo = FALSE}
